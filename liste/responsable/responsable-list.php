										...
										<tr>
											<td>
												<h2 class="table-avatar">
													<a href="" class="avatar"><img alt="image" src="/london-academy/assets/img/responsable/<?php echo htmlentities($row->image_resp); ?>"></a>
													<a href=""> <?php echo htmlentities($row->libelle_resp); ?><span><?php echo htmlentities($row->libelle_resp); ?></span></a>
												</h2>
											</td>			
