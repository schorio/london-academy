						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="departement.php">Liste des departememnts</a></li>
									<li class="breadcrumb-item active"><a href="">Departememnt <?php echo $value_d ?></a></li>
								</ul>
							</div>
								...
								<table class="table table-striped custom-table datatable" id="myTable">
									...
									<?php
											$sql = "SELECT * FROM employee 
													...
													WHERE code_departement = '$value_d' ";
