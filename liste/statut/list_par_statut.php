						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="statut.php">Liste des statuts</a></li>
									<li class="breadcrumb-item active"><a href="">Employé(s) de Statut <?php echo $value_s ?> <?php if ($_SESSION["role"] !== $config["ROLES"][0]){ echo "de votre departement"; } ?></a></li>
								</ul>
							</div>
									...
									<?php
											...
											if ($_SESSION["role"] !== $config["ROLES"][0]) {
												$sql = "SELECT * FROM employee 
														...
														WHERE code_statut = '$vavalue_slue_g' and code_departement='$ut_departement' ";
											}
											else {
												$sql = "SELECT * FROM employee 
															JOIN departement ON employee.id_departement=departement.id_departement 
											...
											if($query->rowCount() > 0)
											{
												...
												{	
													...
													$code_statut = htmlentities($row->code_etablissement);
