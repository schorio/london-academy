						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="grade.php">Liste des grades</a></li>
									<li class="breadcrumb-item active"><a href="">Employé(s) Grader <?php echo $value_g ?> <?php if ($_SESSION["role"] !== $config["ROLES"][0]){ echo "de votre departement"; } ?></a></li>
								</ul>
							</div>
									...
									<?php
											...
											if ($_SESSION["role"] !== $config["ROLES"][0]) {
												$sql = "SELECT * FROM employee 
														...
														WHERE code_grade = '$value_g' and code_departement='$ut_departement' ";
											}
											else {
												$sql = "SELECT * FROM employee 
															JOIN departement ON employee.id_departement=departement.id_departement 
											...
											if($query->rowCount() > 0)
											{
												...
												{	
													...
													$code_grade = htmlentities($row->code_etablissement);
