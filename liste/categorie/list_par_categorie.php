						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="categorie.php">Liste des categories</a></li>
									<li class="breadcrumb-item active"><a href="">Employé(s) de Categorie <?php echo $value_c ?> <?php if ($_SESSION["role"] !== $config["ROLES"][0]){ echo "de votre departement"; } ?></a></li>
								</ul>
							</div>
								...
								<table class="table table-striped custom-table datatable" id="myTable">
									...
									<?php
											...
											if ($_SESSION["role"] !== $config["ROLES"][0]) {
												$sql = "SELECT * FROM employee 
														...
														WHERE code_categorie = '$value_c' and code_departement='$ut_departement' ";
											}
											else {
												$sql = "SELECT * FROM employee 
															JOIN departement ON employee.id_departement=departement.id_departement 
									...
									<tbody>
										<tr>
											...
											<td><?php echo htmlentities($row->code_etablissement);?></td>
